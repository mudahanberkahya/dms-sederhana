...
ALTER TABLE "approval" ADD COLUMN "target_department" varchar(100);--> statement-breakpoint
...
ALTER TABLE "keyword_mapping" ADD COLUMN "step_order" integer;--> statement-breakpoint
ALTER TABLE "user_profile" ADD COLUMN "department" varchar(100);--> statement-breakpoint
ALTER TABLE "workflow" ADD COLUMN "sub_category" varchar(100);--> statement-breakpoint
ALTER TABLE "workflow_step" ADD COLUMN "is_dynamic_department" boolean DEFAULT false NOT NULL;